...
class Sim7600:
    ...
    def get_gnss_info(self):
        ...
        try:
            ...
            r = r.split(",")
            labels = ["fixMode", "gpsSat", "gloSat", "beiSat", "lat", "latInd", "lon", "lonInd", "date", "time", "alt",
...
class Sim7600Component(component.Component):
    ...
    def __init__(self):
        ...
        self.r.set("state:sim7600:custom", json.dumps({"valid": self.valid, "alive": self.alive}))
        ...
        try:
            while self.alive:
                if self.valid:
                    ...
                    data = {"fixMode": 2, "gpsSat": 0, "gloSat": 0, "beiSat": 0,
            ...
            self.log("GPS component stopped unexpectedly: " + str(e), level=ipc.LogLevels.ERROR)
            self.alive = False
            self.valid = False
